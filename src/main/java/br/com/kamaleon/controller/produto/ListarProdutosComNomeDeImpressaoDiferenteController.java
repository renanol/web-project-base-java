...
@Controller
@RequestMapping(value="/listarProdutosComNomeDeImpressaoDiferente")
public class ListarProdutosComNomeDeImpressaoDiferenteController {
	...
	public ModelAndView list(){		
		ModelAndView mav = new ModelAndView("/produto/listarProdutosComNomeDeImpressaoDiferente");		
		return mav;
	}
	
	@RequestMapping(method=RequestMethod.GET, value="/json")
	@ResponseBody()
	public List<Object[]> listar(@RequestParam("codigoProduto") String codigoProduto, @RequestParam("referencia") String referencia, @RequestParam("marca") String marca)  {
        
		return service.listarProdutosComNomeDeImpressaoDiferente(codigoProduto, referencia, marca);
	}
	
	@RequestMapping(method=RequestMethod.GET, value="/xls")
	@ResponseBody()
	private String gerarArquivoExportacaoXls(@RequestParam("codigoProduto") String codigoProduto, @RequestParam("referencia") String referencia, @RequestParam("marca") String marca)
			throws Exception {
		
		String nomeArquivo = "ProdutosComNomeDeImpressaoDiferente.xls";
		
		File arquivo = new File(Constantes.caminhoArquivosXLS + File.separator + nomeArquivo);
		
		String url = arquivo.getAbsolutePath(); 
		List<Object[]> lista = service.listarProdutosComNomeDeImpressaoDiferente(codigoProduto, referencia, marca);
