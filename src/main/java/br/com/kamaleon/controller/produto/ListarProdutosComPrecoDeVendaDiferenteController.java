...
@Controller
@RequestMapping(value="/listarProdutosComPrecoDeVendaDiferente")
public class ListarProdutosComPrecoDeVendaDiferenteController {
	...
	public ModelAndView list(){		
		ModelAndView mav = new ModelAndView("/produto/listarProdutosComPrecoDeVendaDiferente");		
		return mav;
	}
	...
	public List<Object[]> listar(@RequestParam("codigoProduto") String codigoProduto, @RequestParam("referencia") String referencia, @RequestParam("marca") String marca)  {
		...
		return service.listarProdutosComPrecoDeVendaDiferente(codigoProduto, referencia, marca);
	}
	...
	private String gerarArquivoExportacaoXls(@RequestParam("codigoProduto") String codigoProduto, @RequestParam("referencia") String referencia, @RequestParam("marca") String marca)
		...
		String nomeArquivo = "ProdutosComPrecoDeVendaDiferente.xls";
		
		File arquivo = new File(Constantes.caminhoArquivosXLS + File.separator + nomeArquivo);
		
		String url = arquivo.getAbsolutePath(); 
		List<Object[]> lista = service.listarProdutosComPrecoDeVendaDiferente(codigoProduto, referencia, marca);
