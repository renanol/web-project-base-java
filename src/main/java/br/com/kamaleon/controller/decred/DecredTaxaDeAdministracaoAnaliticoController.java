...
@Controller
@RequestMapping(value="/decredTaxaDeAdministracaoAnalitico")
public class DecredTaxaDeAdministracaoAnaliticoController {
	...
	public ModelAndView list(){		
		ModelAndView mav = new ModelAndView("/decred/decredTaxaDeAdministracaoAnalitico");		
		return mav;
	}
	...
	public List<Object[]> decredTotalEncargosAtrasoAnalitico(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal)  {
		...
		return service.decredTaxaDeAdministracaoAnalitico(dataInicial, dataFinal);
	}
	...
	private String gerarArquivoExportacaoXls(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal) throws Exception {
		...
		String nomeArquivo = "decredTaxaDeAdministracaoAnalitico.xls";
