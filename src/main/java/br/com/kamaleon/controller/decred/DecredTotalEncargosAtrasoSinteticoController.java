...
@Controller
@RequestMapping(value="/decredTotalEncargosAtrasoSintetico")
public class DecredTotalEncargosAtrasoSinteticoController {
	...
	public ModelAndView list(){		
		ModelAndView mav = new ModelAndView("/decred/decredTotalEncargosAtrasoSintetico");		
		return mav;
	}
	...
	public List<Object[]> decredTotalEncargosAtrasoSintetico(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal)  {
		...
		return service.decredTotalEncargosAtrasoSintetico(dataInicial, dataFinal);
	}
