...
@Controller
@RequestMapping(value="/decredMultaSobreAtrasoAnalitico")
public class DecredMultaSobreAtrasoAnaliticoController {
	...
	public ModelAndView list(){		
		ModelAndView mav = new ModelAndView("/decred/decredMultaSobreAtrasoAnalitico");		
		return mav;
	}
	...
	public List<Object[]> decredTotalEncargosAtrasoAnalitico(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal)  {
		...
		return service.decredMultaSobreAtrasoAnalitico(dataInicial, dataFinal);
	}
	...
	private String gerarArquivoExportacaoXls(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal) throws Exception {
		...
		String nomeArquivo = "decredMultaSobreAtrasoAnalitico.xls";
