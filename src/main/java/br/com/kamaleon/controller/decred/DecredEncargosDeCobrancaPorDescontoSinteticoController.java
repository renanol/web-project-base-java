...
@Controller
@RequestMapping(value="/decredEncargosDeCobrancaPorDescontoSintetico")
public class DecredEncargosDeCobrancaPorDescontoSinteticoController {
	...
	public ModelAndView list(){		
		ModelAndView mav = new ModelAndView("/decred/decredEncargosDeCobrancaPorDescontoSintetico");		
		return mav;
	}
	...
	public List<Object[]> decredTotalEncargosAtrasoSintetico(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal)  {
		...
		return service.decredEncargosDeCobrancaPorDescontoSintetico(dataInicial, dataFinal);
	}
