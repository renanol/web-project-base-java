...
@Controller
@RequestMapping(value="/decredParcelaDeAnuidadeAnalitico")
public class DecredParcelaDeAnuidadeAnaliticoController {
	...
	public ModelAndView list(){		
		ModelAndView mav = new ModelAndView("/decred/decredParcelaDeAnuidadeAnalitico");		
		return mav;
	}
	...
	public List<Object[]> decredTotalEncargosAtrasoAnalitico(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal)  {
		...
		return service.decredParcelaDeAnuidadeAnalitico(dataInicial, dataFinal);
	}
	...
	private String gerarArquivoExportacaoXls(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal) throws Exception {
		...
		String nomeArquivo = "decredParcelaDeAnuidadeAnalitico.xls";
