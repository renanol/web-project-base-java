...
@Controller
@RequestMapping(value="/decredTaxaDeAdministracaoSintetico")
public class DecredTaxaDeAdministracaoSinteticoController {
	...
	public ModelAndView list(){		
		ModelAndView mav = new ModelAndView("/decred/decredTaxaDeAdministracaoSintetico");		
		return mav;
	}
	...
	public List<Object[]> decredTotalEncargosAtrasoSintetico(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal)  {
		...
		return service.decredTaxaDeAdministracaoSintetico(dataInicial, dataFinal);
	}
	...
	private String gerarArquivoExportacaoXls(@RequestParam("dataInicial") String dataInicial, @RequestParam("dataFinal") String dataFinal) throws Exception {
		...
		String nomeArquivo = "decredTaxaDeAdministracaoSintetico.xls";
		
		File arquivo = new File(Constantes.caminhoArquivosXLS + File.separator + nomeArquivo);
		
		String url = arquivo.getAbsolutePath(); 
		List<Object[]> lista = service.decredTaxaDeAdministracaoSintetico(dataInicial, dataFinal); 
